...
pub contract CryptoPoops: NonFungibleToken {
  ...
  pub resource NFT: NonFungibleToken.INFT {
    ...
    pub let name: String
    pub let favouriteDish: String
    pub let magicNumber: Int

    init(_name: String, _favouriteDish: String, _magicNumber: Int) {
      self.id = self.uuid

      self.name = _name
      self.favouriteDish = _favouriteDish
      self.magicNumber = _magicNumber
    }
  }
  ...
  pub resource Minter {
    ...
    pub fun createNFT(name: String, favouriteDish: String, magicNumber: Int): @NFT {
      return <- create NFT(_name: name, _favouriteDish: favouriteDish, _magicNumber: magicNumber)
    }
